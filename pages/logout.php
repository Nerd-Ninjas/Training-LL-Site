...
?>
<!-- saved from url=(0049)https://spruko.com/demo/ajax/noa/pages/empty.html -->
<html>
  <head>
    ...
    <div class="row">
      <div class="card">
		...
		<!--<script type="text/javascript">   
			...
			document.write("You will be redirected to a login page in 5 seconds"); 
