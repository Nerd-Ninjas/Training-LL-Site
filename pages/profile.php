...
// Determine the header and sidebar to show based on user type
$header_file = $isAdmin ? '../includes/head_main.php' : '../includes/head_login.php';
$sidebar_file = $isAdmin ? '../admin/includes/sidebar.php' : '../includes/sidebar.php';
?>
<!doctype html>
...
<head>
    ...
    <meta name="description" content="User Profile - Learnlike Training">
    ...
    <div class="page">
        <div class="page-main">
                ...
                <div class="app-header header sticky">
                    <div class="container-fluid main-container">
                        <div class="d-flex">
                            ...
                            <a class="logo-horizontal " href="../admin/index.php">
            ...
            <?php endif; ?>
                        ...
                        <!-- Page Title -->
                        <h1 style="font-size:28px; font-weight:700; margin-bottom:24px; color:#1f2937;">
                            <?php echo $isOwnProfile ? 'My Profile' : htmlspecialchars($firstName . ' ' . $lastName) . '\'s Profile'; ?>
                        </h1>
                        ...
                        <div class="info-card">
                            ...
                            <div class="form-grid">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="form-value"><?php echo $isAdmin ? 'Admin' : 'User'; ?></div>
                                </div>
                                <div class="form-group">
