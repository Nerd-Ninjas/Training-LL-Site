...
header("Content-Security-Policy: default-src 'self'; script-src 'self' 'unsafe-inline'; style-src 'self' 'unsafe-inline' https://fonts.googleapis.com; img-src 'self' data: https:; font-src 'self' data: https://fonts.gstatic.com;");
...
if($isLoggedIn) {
	...
	if($userDetails) {
		...
		// Get avatar from avatar table using avatarID
		...
		if(isset($_SESSION["userType"]) && $_SESSION["userType"] == 1) {
			...
			// For regular users, link goes to my_courses page
			$dashboardLink = 'pages/my_courses.php';
		}
	}
}
?>
...
<html lang="en">
	<head>
		...
		<!-- TITLE -->
		<title>Learnlike's - Training Dashboard</title>
		...
		.courses-submenu .dropdown-item {
			padding: 10px 15px;
			border: none;
			color: #333;
		}

		.courses-submenu .dropdown-item:hover {
		...
		.dashboard-item .chevron-icon {
			transition: transform 0.2s ease;
		}

		.dashboard-item.show-submenu .chevron-icon {
			transform: rotate(180deg);
		}
		
		/* Ensure buttons are visible on all screen sizes */
		.hor-header .header-right-icons.d-flex:not(.dropdown) {
		...
		.hor-header .header-right-icons.d-flex:not(.dropdown) .btn {
...
<div class="switcher-wrapper">
				...
				<div class="hor-header header">
					<div class="container main-container">
						<div class="d-flex">
							...
							<?php else: ?>
							<!-- Sign up / Get Started buttons when logged out -->
							<div class="d-flex order-lg-2 ms-auto header-right-icons">
								...
								<div class="navbar navbar-collapse responsive-navbar p-0 navbar-expand-md">
									<div class="collapse navbar-collapse " id="navbarSupportedContent-4">
										<div class="d-flex order-lg-2 m-4 m-lg-0 m-md-1 ">
											<a href="login.php" class="btn btn-pill btn-outline-primary btn-w-md py-2 me-1">
												Sign up
											</a>
											<a href="register.php" class="btn btn-pill btn-primary btn-w-md py-2">
												Get Started
											</a>
										</div>
									</div>
							...
							<!-- NOTIFICATIONS -->
											<?php if ($isLoggedIn): ?>
											<div class="dropdown d-md-flex profile-1 d-flex order-lg-2 ms-auto header-right-icons">
												...
												<div class="dropdown-menu dropdown-menu-end dropdown-menu-arrow">
													...
													<a class="dropdown-item" href="pages/my_courses.php">
					...
					<div class="app-sidebar bg-transparent horizontal-main">
						<div class="container">
							<div class="main-sidemenu navbar px-0">
								...
								<ul class="side-menu">
									<li class="slide"><a class="side-menu__item active" href="#home"><span class="side-menu__label">Home</span></a></li>
									<li class="slide"><a class="side-menu__item" href="#About"><span class="side-menu__label">About</span></a></li>
									<li class="slide"><a class="side-menu__item" href="#Clients"><span class="side-menu__label">Clients</span></a></li>
									<li class="slide"><a class="side-menu__item" href="#Features"><span class="side-menu__label">Features</span></a></li>
									<li class="slide"><a class="side-menu__item" href="#Faq"><span class="side-menu__label">Faq's</span></a></li>
									<li class="slide"><a class="side-menu__item" href="#Team"><span class="side-menu__label">Team</span></a></li>
									<li class="slide"><a class="side-menu__item" href="#Contact"><span class="side-menu__label">Contact</span></a></li>
								</ul>

								<!-- LOGIN / PROFILE SECTION -->
								<?php if ($isLoggedIn): ?>
									<!-- SHOW PROFILE IN SAME POSITION -->
									<div class="header-nav-right d-flex dropdown profile-1 ms-3">
										<a href="#" data-bs-toggle="dropdown" class="nav-link pe-2 leading-none d-flex animate">
											<span>
										...
										<div class="dropdown-menu dropdown-menu-end dropdown-menu-arrow" id="myDropdownMenu">
											...
											<a class="dropdown-item" href="<?php echo htmlspecialchars($dashboardLink); ?>">
												<svg xmlns="http://www.w3.org/2000/svg" class="w-inner-icn" enable-background="new 0 0 24 24" viewBox="0 0 24 24"><path d="M19.5,7H18V6c-0.0018311-1.6561279-1.3438721-2.9981689-3-3H4.5C3.119812,3.0012817,2.0012817,4.119812,2,5.5V18c0.0018311,1.6561279,1.3438721,2.9981689,3,3h14.5c1.380188-0.0012817,2.4987183-1.119812,2.5-2.5v-9C21.9987183,8.119812,20.880188,7.0012817,19.5,7z M4.5,4H15c1.1040039,0.0014038,1.9985962,0.8959961,2,2v1H4.5C3.6715698,7,3,6.3284302,3,5.5S3.6715698,4,4.5,4z M21,16h-2c-1.1045532,0-2-0.8954468-2-2s0.8954468-2,2-2h2V16z M21,11h-2c-1.6568604,0-3,1.3431396-3,3s1.3431396,3,3,3h2v1.5c-0.0009155,0.828064-0.671936,1.4990845-1.5,1.5H5c-1.1040039-0.0014038-1.9985962-0.8959961-2-2V7.4990234C3.4321899,7.8247681,3.9588013,8.0006714,4.5,8h15c0.828064,0.0009155,1.4990845,0.671936,1.5,1.5V11z"/></svg>
												Dashboard
											</a>
											<a class="dropdown-item" href="settings.php">
								...
								<?php else: ?>
									<!-- SHOW SIGNUP BUTTONS WHEN LOGGED OUT -->
									<div class="d-flex order-lg-2 ms-3">
										...
										<div class="navbar navbar-collapse responsive-navbar p-0 navbar-expand-md">
											<div class="collapse navbar-collapse" id="navbarSupportedContent-4">
												<div class="d-flex order-lg-2 m-4 m-lg-0 m-md-1">
													<a href="login.php" class="btn btn-pill btn-outline-primary btn-w-md py-2 me-1">Sign up</a>
													<a href="register.php" class="btn btn-pill btn-primary btn-w-md py-2">Get Started</a>
												</div>
											</div>
										</div>
									</div>
        ...
        <div class="modal buynow buynow-btn ">
			<div class="modal-dialog modal-lg " role="document">
				<div class="modal-content modal-content-demo  cover-image"  data-bs-image-src="assets/switcher/img/16.jpg">
						...
						<button aria-label="Close" class="btn-close" data-bs-dismiss="modal" type="button"><span aria-hidden="true">&times;</span></button>
							<div class="col-sm-10 col-md-8 col-xl-5 col-lg-5">
								<div class="card  border-0 regular-license">
									<div class="card-body imag-list cover-image"  data-bs-image-src="assets/switcher/img/14.jpg">
											...
											<div class="text-center">
												...
												<div class="dropdown">
													...
													<div class="dropdown-menu py-0">
														<a class="dropdown-item  border-bottom px-3" target="_blank" href="https://1.envato.market/BX4yyB">
															<div>
																<p class="tx-14 mb-0 lh-xs font-weight-semibold">Buy Now</p><span class="tx-12 op-7 ">6 months support</span>
															</div>
														</a>
														<a class="dropdown-item   px-3" target="_blank" href="https://1.envato.market/jWvzo5">
															<div>
							...
							<div class="card border-0 ">
								<div class="card-body imag-list cover-image"  data-bs-image-src="assets/switcher/img/15.jpg">
									<div class="text-white">
										...
										<div class="text-center">
											...
											<div class="dropdown">
												...
												<div class="dropdown-menu py-0">
													<a class="dropdown-item  border-bottom px-3" target="_blank" href="https://1.envato.market/zaJbb0">
														<div>
															<p class="tx-14 mb-0 lh-xs font-weight-semibold">Buy Now</p><span class="tx-12 op-7 ">6 months support</span>
														</div>
													</a>
													<a class="dropdown-item   px-3" target="_blank" href="https://1.envato.market/5bVA9L">
														<div>
															<p class="tx-14 mb-0 lh-xs font-weight-semibold">Buy Now</p><span class="tx-12 op-7 ">12 months support</span>
														</div>
													</a>
