...
$(document).on("ready",function(){
    ...
    $('.responsive-screens').not('.slick-initialized').slick({
        slidesToShow: 1,
        slidesToScroll: 1,
        autoplay: true,
        autoplaySpeed: 5000,
...
$('#myonoffswitch24').on('click', function () {
    if (this.checked) {
        $('body').addClass('rtl');
        $('.slick-slider').not('.slick-initialized').slick('slickSetOption', 'rtl', true);
...
$('#myonoffswitch23').on('click', function () {
    if (this.checked) {
        $('body').addClass('ltr');
        $('.slick-slider').not('.slick-initialized').slick('slickSetOption', 'rtl', false);
