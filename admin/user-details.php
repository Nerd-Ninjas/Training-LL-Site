        ...
        <div class="page-main">
                            ...
                            <div class="dropdown d-flex profile-1">
                                ...
                                <div class="dropdown-menu dropdown-menu-end dropdown-menu-arrow">
                                    ...
                                    <a class="dropdown-item" href="../logout.php">
                                        <svg class="svg-icon me-2" xmlns="http://www.w3.org/2000/svg" height="24" viewBox="0 0 24 24" width="24"><path d="M17 3H5c-1.11 0-2 .9-2 2v14c0 1.1.89 2 2 2h14c1.1 0 2-.9 2-2V7l-4-4z"></path></svg>Logout
                                    </a>
                                </div>
                            </div>
                        </div>
            ...
            <aside class="app-sidebar sticky">
                ...
                <ul class="side-menu">
                    ...
                    <li class="side-item">
                        <a class="side-menu__item" href="user_management.php">
